...
var AppRouter = Backbone.Router.extend({
    ...
    coiDetails:function (id) {
        //console.log("switching to single coi view");
        var c = cl.get(id);
        $('#content').html(new CoiView({model:c}).render().el);
        $('ul.nav > li').removeClass('active');
        $('li > a[href*="/cois"]').parent().addClass('active');
    },
    
    coiList:function () {
        //console.log("switching to CoI list view");
        $('#content').html(new CoiListView({model:cl}).render().el);
        $('ul.nav > li').removeClass('active');
        $('li > a[href*="/cois"]').parent().addClass('active');
    },
...
var cl = new CoiCollection();

var updating = true;

tpl.loadTemplates(['home', 'status', 'topology', 'header', 'switch', 'switch-list', 'switch-list-item', 'host', 'host-list', 'host-list-item', 'port-list', 'port-list-item', 'flow-list', 'flow-list-item', 'coi', 'coi-list', 'coi-list-item'],
    function () {
        app = new AppRouter();
